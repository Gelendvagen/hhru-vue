...
<template>
    ...
    <div v-else>
        ...
        <div class="flex align-items-center mb-5">
            ...
            <app-button severity="danger" :disabled="!selectedFilterResult" @click="clearFilter">Сбросить</app-button>
        </div>
        <app-datatable :value="interviews">
            ...
            <app-column header="Результат">
                <template #body="slotProps">
                    ...
                    <template v-else>
                        <app-badge :severity="slotProps.data.result === 'Offer' ? 'success' : 'danger'" :value="slotProps.data.result === 'Offer' ? 'Оффер' : 'Отказ'" />
                    </template>
                </template>
            </app-column>
            <app-column>
